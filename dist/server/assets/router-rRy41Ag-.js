...
const appCss = "./assets/styles-DJ1kqQba.css";
...
const $$splitComponentImporter = () => import("./index-B-CUCGXO.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "STAFF READY: شركة رائدة في نقل الموظفين والرحلات الجماعية بأسطول حديث من 120 حافلة وخبرة 15 سنة."
    }, {
      property: "og:title",
      content: "STAFF READY — حلول النقل المؤسسي"
    }, {
