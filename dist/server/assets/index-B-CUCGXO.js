import { r as reactExports, T as jsxRuntimeExports } from "./worker-entry-Xel4lCuM.js";
import "node:events";
...
const Car = createLucideIcon("car", __iconNode$8);
const __iconNode$7 = [
  [
    "path",
    {
...
const Diamond = createLucideIcon("diamond", __iconNode$7);
const __iconNode$6 = [
...
const Languages = createLucideIcon("languages", __iconNode$4);
const __iconNode$3 = [
...
const myServices = [
  { id: 1, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { size: 32 }), title: { ar: "نقل الموظفين", en: "Employee Transport" }, desc: { ar: "عقود يومية وشهرية للشركات والمصانع.", en: "Daily and monthly contracts for companies and factories." } },
  { id: 2, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { size: 32 }), title: { ar: "خدمة المدارس والجامعات", en: "School & University Services" }, desc: { ar: "وسيلة آمنة ومريحة للطلاب.", en: "Safe and comfortable transport for students." } },
  { id: 3, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 32 }), title: { ar: "رحلات سياحية", en: "Tourism Trips" }, desc: { ar: "رحلات داخلية وخارجية للمجموعات والشركات والمدارس.", en: "Domestic and international trips for groups, companies, and schools." } },
  { id: 4, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Diamond, { size: 32 }), title: { ar: "خدمة كبار الشخصيات", en: "VIP Services" }, desc: { ar: "نقل رجال الأعمال بسيارات فاخرة.", en: "VIP transportation for business professionals in luxury cars." } },
  { id: 5, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { size: 32 }), title: { ar: "خدمة المناسبات", en: "Event Services" }, desc: { ar: "حفلات، مؤتمرات، سفر.. هنوصلك بكل راحة وأمان وأناقة.", en: "Conferences, events, and travel.. reaching you with comfort, safety, and style." } }
];
const fleetImages = [
  {
    src: "/images/bus1.jpg",
...
function StaffReadyLanding() {
  ...
  reactExports.useEffect(() => {
    ...
    const savedLang = window.localStorage.getItem("sr-lang");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { dir, className: "min-h-screen bg-background text-foreground antialiased", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        className: `sticky top-0 z-50 transition-all duration-300 ${scrolled ? "backdrop-blur-2xl bg-background/60 border-b border-border/60 shadow-lg shadow-primary/5" : "backdrop-blur-md bg-background/30 border-b border-transparent"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "w-full px-5 h-20 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.a,
              {
                href: "#",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-12 md:h-14 w-12 md:w-14 rounded-2xl overflow-hidden bg-white ring-1 ring-primary/30 shadow-md shadow-primary/20 transition-shadow duration-300 group-hover:shadow-xl group-hover:shadow-primary/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: "/images/logo.jpg",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "hidden sm:inline font-extrabold tracking-tight text-lg leading-none", dir: "ltr", children: [
                    "STAFF ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "READY" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center gap-8 text-sm font-medium", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: !mounted ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-5 w-5" }) : dark ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-5 w-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "h-5 w-5" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
          ...
          menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden border-t border-border bg-background/95 backdrop-blur px-5 py-4 flex flex-col gap-3 text-sm font-medium", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", onClick: () => setMenuOpen(false), children: L.nav.home }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "#services",
                ...
                children: lang === "ar" ? "الخدمات" : "Services"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#fleet", onClick: () => setMenuOpen(false), children: L.nav.fleet }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#luxury-fleet", onClick: () => setMenuOpen(false), className: "py-2 hover:text-sky-400 active:text-sky-500 transition-colors", children: lang === "ar" ? "الأسطول الفاخر" : "Luxury Fleet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#testimonials", onClick: () => setMenuOpen(false), className: "py-2 hover:text-sky-400 active:text-sky-500  transition-colors", children: lang === "ar" ? "تجارب عملائنا" : "Our Experience" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#about", onClick: () => setMenuOpen(false), className: "hover:text-sky-400 active:text-sky-500 transition-colors duration-300 font-bold", children: lang === "ar" ? "من نحن" : "About Us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", onClick: () => setMenuOpen(false), className: "inline-flex w-fit items-center gap-2 rounded-full bg-primary text-primary-foreground px-4 py-2 font-semibold", children: L.bookNow })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "group/hero relative isolate overflow-hidden min-h-[88vh] flex items-center justify-center cursor-default", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.h1,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block mt-2 bg-gradient-to-l from-primary to-sky-300 bg-clip-text text-transparent text-3x1 md:text-6x1", children: L.heroTitle2 })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "py-24 bg-white dark:bg-slate-950 transition-colors duration-500 scroll-mt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
          ...
          children: lang === "ar" ? "خدماتنا" : "Our Services"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: myServices.map((service, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 bg-gradient-to-br from-sky-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 text-white shadow-lg shadow-sky-500/20 group-hover:scale-110 group-active:scale-110 transition-transform duration-300", children: service.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-4 text-slate-900 dark:text-white group-hover:text-sky-500  active:text-sky-500 transition-colors duration-300", children: lang === "ar" ? service.title.ar : service.title.en }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 dark:text-gray-400 leading-relaxed transition-colors duration-300", children: lang === "ar" ? service.desc.ar : service.desc.en })
          ]
        },
        service.id
      )) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "fleet", className: "mx-auto max-w-full px-5 py-24 scroll-mt-32", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-5xl font-extrabold tracking-tight dark:text-white", children: lang === "ar" ? "أسطولنا" : "Our Fleet" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: fleetImages.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              variants: fadeUp,
              whileHover: { y: -10 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-3xl", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: img.src,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-300 flex items-center justify-center p-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xl font-bold tracking-wide", children: img.name[lang] }) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 p-2 transition-colors duration-300", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-slate-900 dark:text-white group-hover:text-sky-600 group-active:text-sky-700 transition-colors duration-300", children: img.name[lang] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-slate-600 dark:text-gray-400 group-hover:text-slate-800 dark:group-hover:text-sky-400 transition-colors duration-300", children: img.desc[lang] })
                ] })
              ]
            },
            i
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "luxury-fleet", className: "py-24 bg-white dark:bg-slate-950 transition-colors duration-500 scroll-mt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-full mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
          initial: { opacity: 0, y: -20 },
          whileInView: { opacity: 1, y: 0 },
          className: "text-4xl md:text-5xl font-bold text-center mb-16 text-slate-900 dark:text-white",
          children: lang === "ar" ? "أسطولنا الفاخر والمكيف" : "Our Luxury Climate-Controlled Fleet"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8", children: luxuryFleetImages.map((car, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-t-3xl", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100  group-active:opacity-100 transition-opacity duration-300 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-2xl font-bold tracking-wider", children: car.name.en }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 transition-colors duration-300", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-slate-900 dark:text-white group-hover:text-sky-600 group-active:text-sky-700 transition-colors duration-300", children: car.name[lang] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-slate-600 dark:text-gray-400 group-hover:text-slate-800 group-active:text-slate-800 dark:group-hover:text-sky-400  active:text-sky-500 transition-colors duration-300", children: car.desc[lang] })
            ] })
          ]
        },
        index
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 px-6 max-w-7xl mx-auto scroll-mt-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-3xl md:text-5xl font-black mb-6 cursor-pointer text-gray-900 dark:text-gray-100 hover:text-sky-500 active:text-sky-500 transition-colors duration-300", children: [
          lang === "ar" ? "من نحن " : "Who we are ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sky-500", children: "Staff Ready" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-900 dark:text-gray-100 text-lg leading-relaxed font-medium cursor-pointer hover:text-sky-500 active:text-sky-500 transition-colors duration-300", children: lang === "ar" ? "Staff Ready هي شركة متخصصة في خدمات النقل الجماعي والفردي، من خلال أسطول متنوع من العربات الملاكي، الميكروباص، الميني باص، والأتوبيسات المكيفة." : "Staff Ready is a specialized company in group and individual transport services, providing smart and flexible transport solutions for companies, schools, businesses, through a diverse fleet of cars, microbuses, minibuses, and air-conditioned buses." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/images/bus7.jpg", alt: "Staff Ready Fleet", className: "w-full h-full object-cover" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black opacity-0 transition-opacity duration-300 group-hover:opacity-40 group-active:opacity-40" })
          ]
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "features", className: "py-24 bg-slate-50/5 dark:bg-white/5 backdrop-blur-sm scroll-mt-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-4xl md:text-6xl font-black text-foreground italic", children: lang === "ar" ? "لماذا تختارنا؟" : "Why Choose Us?" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: [
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-14 w-14 rounded-full bg-sky-500/15 dark:bg-sky-500/20 flex items-center justify-center text-sky-500 group-hover:bg-sky-500 group-hover:text-white transition-all duration-300 font-bold", children: "✓" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-extrabold text-xl leading-tight transition-colors duration-300\n                             /* لون النص في الوضع العادي */\n                             text-slate-800\n                             /* لون النص في الدارك مود - أبيض واضح جداً */\n                             dark:text-white \n                             group-hover:text-sky-500  active:text-sky-500 group-hover:dark:text-sky-400 active:dark:text-sky-400", children: lang === "ar" ? feature.ar : feature.en })
          ]
        },
        idx
      )) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "testimonials", className: "py-24 bg-gray-50 dark:bg-slate-900 transition-colors duration-500 scroll-mt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.h2,
        {
          initial: { opacity: 0, y: -20 },
          ...
          viewport: { once: true },
          className: "text-4xl md:text-5xl font-bold text-center mb-16 text-slate-900 dark:text-white",
          children: lang === "ar" ? "آراء شركائنا في تجربتهم معنا" : "What Our Partners Say About Us"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: CLIENTS.map((partner, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-lg text-slate-900 dark:text-white transition-colors duration-300 group-hover:text-sky-500  active:text-sky-600 dark:group-hover:text-sky-400  active:text-sky-400", children: partner.name })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-slate-600 dark:text-gray-400 leading-relaxed italic transition-colors duration-300 group-hover:text-slate-900 dark:group-hover:text-gray-100", children: [
              '"',
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "scroll-mt-28 py-32 mx-auto max-w-7xl px-5 pb-24 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 bg-card/60 backdrop-blur-xl p-8 rounded-3xl border border-border shadow-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-8 text-primary border-r-4 border-primary pr-4", children: "للتواصل والاستفسار" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: CONTACT_PERSONS.map((person, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-2xl bg-secondary/20 border border-border/40 hover:border-primary/50  active:border-primary/50 transition-all", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-1 font-medium", children: person.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:${person.phone}:", className: "text-md font-extrabold hover:text-primary  active:text-primary transition-colors block", children: person.phone })
        ] }, index)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold mb-6 text-center lg:text-right", children: "تابعونا على منصاتنا" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: SOCIAL_LINKS.map((link, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.url,
            target: "_blank",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 py-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/images/logo.jpg", alt: "STAFF READY", className: "h-7 w-7 object-contain rounded" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: "STAFF READY" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        "© ",
...
const SplitComponent = StaffReadyLanding;
export {
